...
El proceso l\'ogico de trabajo en cuanto a las herramientas utilizadas y al formato de los datos se muestra en la Figura~\ref{fig:diagram}. 
...
\captionof{figure}{Diagrama de fases}
\label{fig:diagram}        
\end{center}
